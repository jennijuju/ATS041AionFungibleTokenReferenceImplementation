   ...
   // private String tokenNameNull = "";
    ...
    public void deployDapp() {
        ...
        byte[] data = encoder.encodeOneString(tokenName)
                                ...
                                .toBytes();
        byte[] contractData = avmRule.getDappBytes(AIP041Standard.class, data, AIP041Event.class, AIP041KeyValueStorage.class);
    ...
    public void testInitialization() {
        ...
        resBytes = (BigInteger) result.getDecodedReturnData();
        Assert.assertTrue(resBytes.compareTo(tokenTotalSupply) == 0);
    }
    ...
    public void testAutorizeOperator4() {
        ...
        // validate the topics and data
        assertArrayEquals(LogSizeUtils.truncatePadTopic("AuthorizedOperator".getBytes()), result.getTransactionResult().logs.get(0).copyOfTopics().get(0));
        assertArrayEquals(LogSizeUtils.truncatePadTopic(operator2.toByteArray()), result.getTransactionResult().logs.get(0).copyOfTopics().get(1));
        assertArrayEquals(LogSizeUtils.truncatePadTopic(tokenHolder.toByteArray()), result.getTransactionResult().logs.get(0).copyOfTopics().get(2));
        assertArrayEquals(new byte[0],result.getTransactionResult().logs.get(0).copyOfData());
...
//        Assert.assertTrue(result.getReceiptStatus().isSuccess());
    ...
    public void testRevokeOperator4() {
        ...
        // validate the topics and data
        assertArrayEquals(LogSizeUtils.truncatePadTopic("RevokedOperator".getBytes()), result.getTransactionResult().logs.get(0).copyOfTopics().get(0));
        assertArrayEquals(LogSizeUtils.truncatePadTopic(operator4.toByteArray()), result.getTransactionResult().logs.get(0).copyOfTopics().get(1));
        assertArrayEquals(LogSizeUtils.truncatePadTopic(tokenHolder.toByteArray()), result.getTransactionResult().logs.get(0).copyOfTopics().get(2));
        assertArrayEquals(new byte[0],result.getTransactionResult().logs.get(0).copyOfData());
    ...
    public void testRevokeOperator5() {
        ...
        // validate the topics and data
        assertArrayEquals(LogSizeUtils.truncatePadTopic("RevokedOperator".getBytes()), result.getTransactionResult().logs.get(0).copyOfTopics().get(0));
        assertArrayEquals(LogSizeUtils.truncatePadTopic(operator3.toByteArray()), result.getTransactionResult().logs.get(0).copyOfTopics().get(1));
        assertArrayEquals(LogSizeUtils.truncatePadTopic(tokenHolder.toByteArray()), result.getTransactionResult().logs.get(0).copyOfTopics().get(2));
        assertArrayEquals(new byte[0],result.getTransactionResult().logs.get(0).copyOfData());
    ...
    public void testSend2() {
        ...
        Assert.assertTrue(result.getReceiptStatus().isSuccess());
        resBI = (BigInteger) result.getDecodedReturnData();
        Assert.assertTrue(resBI.compareTo(tokenTotalSupply.subtract(BigInteger.valueOf(3).multiply(nAmp).multiply(BigInteger.TWO))) == 0);
