...
public class AIP041TokenContract {
    ...
    static {
        ...
        AIP041Implementation.tokenCreator = Blockchain.getCaller();
        AIP041Implementation.tokenIssuers.add(Blockchain.getCaller());
        AIP041Event.AIP041AIPTokenCreated(AIP041TokenName, AIP041TokenSymbol, AIP041TokenGranularity, Blockchain.getCaller());
    }
    ...
    @Callable
    public static Address AIP041GetTokenCreator() {
        return AIP041Implementation.AIP041GetTokenCreator();
    }

    @Callable
    public static void AIP041AddTokenIssuer(Address newIssuer) {
         AIP041Implementation.AIP041AddTokenIssuer(newIssuer);
    }

    @Callable
    public static void AIP041RemoveTokenIssuer(Address oldIssuer) {
        AIP041Implementation.AIP041RemoveTokenIssuer(oldIssuer);

    }

    @Callable
    public static Address[] AIP041GetTokenIssuers() {
        return AIP041Implementation.AIP041GetTokenIssuers();
    }

    @Callable
    public static boolean AIP041IsTokenIssuer(Address issuer) {
        return AIP041Implementation.AIP041IsTokenIssuer(issuer);
    }
    ...
    @Callable
    public static void AIP041Mint(Address to, BigInteger amount, byte[] data, byte[] issuerData) {
        AIP041Implementation.AIP041Mint(to, amount, data, issuerData);
    }
    @Callable
